    ...
    <div className='w-screen h-[80px] z-10 bg-zinc-200 fixed drop-shadow-lg'>
      <div className='px-2 flex justify-between items-center w-full h-full'>
        <div className='flex items-center'>
          ...
          <li><Link className='sss' to="home" smooth={true} duration={500}>Home</Link></li>
          <li><Link className='sss' to="about" smooth={true} offset={-200} duration={500}>About</Link></li>
          <li><Link className='sss' to="support" smooth={true} offset={-50} duration={500}>Support</Link></li>
          <li><Link className='sss' to="platforms" smooth={true} offset={-100} duration={500}>Platforms</Link></li>
          <li><Link className='sss' to="pricing" smooth={true} offset={-50} duration={500}>Pricing</Link></li>
          </ul>
        </div>
